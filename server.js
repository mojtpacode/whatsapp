...
// إعداد متصفح Puppeteer بخيارات خفيفة تناسب استضافة Railway
...
// تحويل الـ QR Code فور توليده إلى صورة Base64
client.on('qr', async (qr) => {
    try {
        qrCodeImage = await QRCode.toDataURL(qr);
        console.log('--- تم توليد رمز QR بنجاح! افتح الرابط /qr في المتصفح ---');
    } catch (err) {
